...
- NCAA Football AP Weekly Vote Predictions (Forthcoming): Building a predictive model to forecast weekly AP Top 25 rankings using team performance metrics.
- eBird Data Mapping with R Shiny: Developing an interactive application to visualize birding data from eBird, allowing users to explore species distribution and trends.
- Intro Scripts for RStudio: Creating a series of beginner-friendly R scripts to help new users get started with data manipulation and visualization in RStudio.
